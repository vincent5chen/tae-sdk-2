...
java_found(){
	...
	JAVA_OPTS="-DDCSDK_HOME=$DCSDK_HOME -Dmain.class=com.taobao.tae.sdk.platform.Main -Djava.io.tmpdir=$DCSDK_HOME/temp -DSTART=$DCSDK_HOME/conf/start.config -Dassets.host=a.tbcdn.cn"
	START_JAR=""
